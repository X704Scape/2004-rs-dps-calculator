...
export default function AIChatModal({ playerStats, monster, availableMonsters, onApplyLoadout, onSetMonster, onClose }) {
  ...
  const handleInteraction = async (interaction) => {
    if (interaction.type === 'styleChoice') {
      ...
      onApplyLoadout(interaction.loadout.equipment, interaction.loadout.combatType, interaction.loadout.style);
      onClose();
    }
  };
